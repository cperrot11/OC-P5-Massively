...
<div id="main">
    <section class="post">
        ...
        <form method="post" action="index.php?route=updateComment<?= "&idArt=".$_GET['idArt']."&idComment=".$_GET['idComment']."&appel=".$_GET['appel'];?>#begin">
            <?= $formulaire;?>
        ...
        <a href="index.php#begin">Retour à l'accueil</a>
    </section>
</div>
