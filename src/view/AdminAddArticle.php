<div id="main">
    <section class="post">
        ...
        <div class="row gtr-uniform">
            <form method="post" action="index.php?route=addArticle#begin" enctype="multipart/form-data">
        ...
        <div>
            ...
            <a class="button" href="index.php?route=accueil#begin">Retour à l'acceuil du blog</a>
        </div>
    </section>
</div>
