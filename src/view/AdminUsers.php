...
<div id="main">
    <section class="post">
        ...
        <br/>
        <a class="button" href="index.php?route=addUser#begin">Nouvel utilisateur</a>
                        ...
                        foreach ($users as $user)
                        {
                            ?>
                                <tr class="table-light">
                                    ...
                                    <td><a title="Modifier" class="icon fa-edit" href="index.php?route=updateUser&login=<?= htmlspecialchars($user->getLogin());?>&appel=back#begin"></a></td>
                                    <td>
                                        <form id="deleteform<?= $user->getLogin();?>" method="post" action="index.php?route=deleteUser&login=<?= htmlspecialchars($user->getLogin());?>">
